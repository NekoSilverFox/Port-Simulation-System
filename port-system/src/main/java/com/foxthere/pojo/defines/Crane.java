...
public class Crane {
    /**
     * 起重机可以处理的货物类型
     * Типы грузов, которые могут быть обработаны кранами
     */
    private TypeGoods typeCrane;

    /**
     * 起重机的效率：每处理一件或者一吨所需的时间（单位：ms）
     * Эффективность крана: время, затрачиваемое на каждую обработанную деталь или тонну (в мс).
     */
    private long workpieceRatio;

    /**
     * 每台起重机的价格（默认 30000 美金）
     * Цена за один кран (по умолчанию 30 000 долл. США)
     */
    private int price;
