...
//        return resultsArrayList;
    ...
    @ResponseBody
    public ArrayList<StatisticalResults> generateSimulationResults(@PathVariable String jsonFileName) {

        /** ↓ ↓ ↓ ↓ ↓ ↓ ↓ ↓ ↓ ↓ ↓ ↓  先 GET 获取 FreighterTimetable 表 ↓ ↓ ↓ ↓ ↓ ↓ ↓ ↓ ↓ ↓ ↓ ↓ */
        String urlGet = "http://localhost:8080/controller2/getFreighterTimetable/" + jsonFileName;
...
//            StatisticalResults statisticalResults = mapper.readValue(result, StatisticalResults.class);
//            StatisticalModels.printStatistics(statisticalResults, "Results-AllFreighters");
